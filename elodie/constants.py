...
if "ELODIE_APPLICATION_DIRECTORY" in environ and path.isdir(
    environ["ELODIE_APPLICATION_DIRECTORY"]
):
...
if "ELODIE_MAPQUEST_BASE_URL" in environ and environ["ELODIE_MAPQUEST_BASE_URL"] != "":
    mapquest_base_url = environ["ELODIE_MAPQUEST_BASE_URL"]

#: MapQuest key from environment
mapquest_key = None
if "ELODIE_MAPQUEST_KEY" in environ and environ["ELODIE_MAPQUEST_KEY"] != "":
